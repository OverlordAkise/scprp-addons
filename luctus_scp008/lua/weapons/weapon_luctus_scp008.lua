...
SWEP.PrintName = "SCP008 Fists"
SWEP.Author = "Kilburn, robotboy655, MaxOfS2D & Tenrys"
SWEP.Purpose = "Infect others with SCP008 by hitting them"
SWEP.Category = "SCP"
...
function SWEP:DealDamage()
	...
	if ( SERVER && IsValid( tr.Entity ) && ( tr.Entity:IsNPC() || tr.Entity:IsPlayer() || tr.Entity:Health() > 0 ) ) then
        ...
        LuctusSCP008StartInfection(tr.Entity,LUCTUS_SCP008_INFECTION_RAISEDBYHIT)
